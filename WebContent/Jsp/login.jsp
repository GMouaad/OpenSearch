	...
	<div class="menu trans_500">
		<div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
			...
			<div class="logo menu_logo">
				<a href="#">
					<div class="logo_container d-flex flex-row align-items-start justify-content-start">
						<div class="logo_image"><div><img src="${pageContext.request.contextPath}/resources/images/Logo.jng" alt=""></div></div>
			...
			<ul>
				...
				<li class="menu_item"><a href="#">Projects</a></li>
							...
							<div class="col">
								<div class="header_top_content d-flex flex-row align-items-center justify-content-start">
									<div>
										<a href="#">
											<div class="logo_container d-flex flex-row align-items-start justify-content-start">
												<div class="logo_image"><div><img src="${pageContext.request.contextPath}/resources/images/logo.png" alt=""></div></div>
												<div class="logo_content">
										...
										<div class="header_nav_content d-flex flex-row align-items-center justify-content-start">
											<nav class="main_nav">
												<ul>
													...
													<li><a href="speakers.html">Projects</a></li>
											...
											<div class="header_extra ml-auto">
												...
												<div class="button header_button"><a href="#">Post your Project now!</a></div>
											</div>
										</div>
									</div>
								</div>
					...
					<div class="col-lg-3 footer_col">
						<div class="footer_links">
							<ul>
								...
								<li><a href="${pageContext.request.contextPath}/Jsp/login.jsp">Projects</a></li>
